var null_pcode_arg = unary_minus(1);
var pam_local = 0;
...
var opKinds = seqDataInt_kind;
mk_emptysequence();
var opNames = seqDataOb_kind;
mk_emptysequence();
...
function initOpKinds() {
	 < unknown Xob type >  : rdfs : ResourceseqintExpand(opKinds, 100);
	opKinds[integer_minus_op] = opKind_int_int;
	opKinds[integer_not_op] = opKind_int_int;
	opKinds[boole_not_op] = opKind_int_int;
	for (i = 35; leq(i, 41); plus_plus(i))
		opKinds[i] = opKind_int_int_int; ;
	for (i = 43; leq(i, 45); plus_plus(i))
		opKinds[i] = opKind_int_int_int; ;
	for (i = 48; leq(i, 49); plus_plus(i))
		opKinds[i] = opKind_int_int_int; ;
